...
def start(bot, update):
    ...
    update.message.reply_text('Hi! I can determine current weather at city. If you need help, please press /help')

def help(bot, update):
    """Send a message when the command /help is issued."""
    update.message.reply_text('Just type, for example, /weather Melaka')
...
def weather(bot, update, args):
    ...
    owm = pyowm.OWM('4bf2d7e9ec1e107b4ed58c71789a2a46')
...
def main():
    ...
    updater = Updater("647881472:AAGCNuvYTjkDNZlbUEPJwwxTqE2RBl2ckvA")
